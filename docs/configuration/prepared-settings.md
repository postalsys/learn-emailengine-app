...
```bash
export EENGINE_PREPARED_LICENSE=EELICENSE-xxxxx-xxxxx-xxxxx-xxxxx
emailengine
```
...
```bash
emailengine --preparedLicense="EELICENSE-xxxxx-xxxxx-xxxxx-xxxxx"
```

#### Docker

```dockerfile
ENV EENGINE_PREPARED_LICENSE=EELICENSE-xxxxx-xxxxx-xxxxx-xxxxx
```
