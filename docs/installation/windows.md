...
# Look for EmailEngine events

# Test manually
& "C:\Program Files\EmailEngine\emailengine.exe"
```
...
icacls "C:\Program Files\EmailEngine" /grant Users:F /T
```
...
```powershell
# Add firewall rule
New-NetFirewallRule -DisplayName "EmailEngine" -Direction Inbound -Protocol TCP -LocalPort 3000 -Action Allow

# Or open Windows Defender Firewall
