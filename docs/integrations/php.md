...
**Problem**: Cannot connect to EmailEngine

**Solutions**:
- Verify EmailEngine is running
- Check firewall rules
- Verify base URL is correct
- Test with curl: `curl http://127.0.0.1:3000/health`
...
**Solutions**:
- Generate new token in EmailEngine interface
...
- Test manual connection with email client
- Check EmailEngine logs for details
...
**Solutions**:
- Verify account is in "connected" state
