...
- [Basic Sending](./basic-sending.md) - REST API email sending
- [Mail Merge](./mail-merge.md) - Bulk personalized sending (REST only)
- [Templates](./templates.md) - Email templates (REST only)
- [Outbox Queue](./outbox-queue.md) - Queue monitoring
